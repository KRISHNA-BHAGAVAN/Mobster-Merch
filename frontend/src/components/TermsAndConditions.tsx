      ...
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="font-serif prose prose-invert max-w-none text-foreground/80 leading-relaxed space-y-6 text-base">
          ...
          <p>
            ...
            https://mobstermerch.store/ ('Website'), including the related mobile site and mobile application
            (hereinafter referred to as 'Platform').
          </p>
          
          <p>
            The Platform is owned by MOBSTER MERCH, a company incorporated under the Companies
            Act, 1956 with its registered office at India (hereinafter referred to as 'Platform Owner', 'we', 'us',
            'our').
          </p>
          ...
          <ol className="list-decimal list-inside space-y-4 ml-4">
            ...
            <li>
              ...
              jurisdiction of the courts in Tuni and Andhra Pradesh.
            </li>
