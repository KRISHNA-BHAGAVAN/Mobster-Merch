  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <h1 className="heading-font text-4xl text-center mb-8">Privacy Policy</h1>
        <div className="font-serif prose prose-invert max-w-none text-foreground/80 leading-relaxed space-y-6 text-base">
          ...
          <section>
            ...
            <p>
              This Privacy Policy describes how MOBSTER MERCH and its affiliates (collectively "MOBSTER
              MERCH, we, our, us") collect, use, share, protect or otherwise process your information/ personal data
              through our website https://mobstermerch.store/ (hereinafter referred to as Platform). Please note that
              you may be able to browse certain sections of the Platform without registering with us. We do not offer
              any product/service under this Platform outside India and your personal data will primarily be stored and
          ...
          <section>
            ...
            <p>
              If you receive an email, a call from a person/association claiming to be MOBSTER 
              MERCH seeking any personal data like debit/credit card PIN, net-banking or mobile banking password,
          ...
          <section>
            ...
            <p>
              ...
              messaging apps, call and/or e-mail for the purposes specified in this Privacy Policy.
            </p>
            <p>
              You have an option
